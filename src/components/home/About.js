    ...
    <Fragment>
        <section id='nosotros' className={`${styles.about}`}>
            <div className="wrap flex flex-col items-end sm:items-start py-16">
                ...
                <p className='text-white w-[55%] sm:w-full text-right sm:text-left pb-4'>Somos una consultora especializada en asesoramiento experto en Recursos Humanos, ofrecemos servicios centrados en lograr expandir la estrategia de negocio de las empresas con equipos motivados y satisfechos. Nuestros servicios se destacan por garantizar la excelencia en diferentes áreas de Recursos Humanos a través de nuestra asesoría experta integral, nos apasiona acompañar brindando soluciones a la medida de nuestros clientes.</p>
                ...
                <p className='text-white w-[55%] sm:w-full text-right sm:text-left pb-4'>Creemos que el crecimiento de las organizaciones está directamente relacionado con el factor humano, es decir que las personas sean protagonistas, se sienten parte de los objetivos de la empresa, motivados y comprometidos con las tareas que desempeñan.</p>
