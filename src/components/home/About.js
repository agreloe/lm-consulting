    ...
    <Fragment>
        <section id='nosotros' className={`${styles.about}`}>
            <div className="wrap flex flex-col items-end sm:items-start py-16">
                ...
                <p className='text-white w-[55%] sm:w-full text-right sm:text-left pb-4'>Somos una consultora especializada en asesoramiento experto en Recursos Humanos, ofrecemos servicios centrados en lograr expandir la estrategia de negocio de las empresas con equipos motivados y satisfechos.</p>
