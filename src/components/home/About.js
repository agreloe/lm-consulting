    ...
    <Fragment>
        <section id='nosotros' className={`${styles.about}`}>
            <div className="wrap flex flex-col items-end sm:items-start py-16">
                <h2 className='text-white pb-16 sm:pb-8'>Nosotros</h2>
                ...
                <p className='text-white w-[55%] sm:w-full text-right sm:text-left pb-4'>Trabajamos en conjunto y de manera colaborativa. Somos profesionales con un gran recorrido académico y laboral, nos especializamos en Recursos Humanos, Psicología, Coaching Ejecutivo, Life Coaching, Seguridad e Higiene, Derecho Laboral entre otras.</p>
                ...
                <p className='text-white w-[55%] sm:w-full text-right pb-4 sm:text-left'>Nuestros valores hacen que marquemos la diferencia en nuestro trabajo día a día, son nuestra esencia y razón de ser. Nos guían el Compromiso, Profesionalismo, Transparencia, Dedicación, Integridad y Empatía</p>
            </div>
