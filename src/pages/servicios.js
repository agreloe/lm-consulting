        ...
        <div className="wrap flex gap-4 flex-wrap md:justify-center">
          ...
          <div id='busqueda' className={`py-8 px-4 rounded-[10px] bg-[#EEFAFF] ${styles.box}`}>
            ...
            <div id='box-content' className={`${styles["box-content"]} ${open && selectedRow === 1 ? `${styles.active}` : ``}`}>
              ...
              <p>Nuestro compromiso es ofrecer nuestra mirada objetiva y sincera sobre la situación del mercado, de la empresa, de sus procesos, de los puestos y de sus perfiles, con el fin de poder asegurar la contratación de los talentos más calificados con una resolución rápida y certera.</p>
          ...
          <div id='analisis' className={`py-8 px-4 rounded-[10px] bg-[#FDFEFF] ${styles.box}`}>
            ...
            <div id="box-content" className={`${styles["box-content"]} ${open && selectedRow === 2 ? `${styles.active}` : ``}`}>
              ...
              <ul>
                ...
                <li>Evitar la duplicación de tareas, roles confusos, áreas sobrecargadas generando  confusión en cuanto a sus responsabilidades , permitiendo de esta manera una correcta distribución de tareas.</li>
                <li>Identificar las brechas existentes y áreas de mejora en la estructura y puestos de trabajo asignando eficientemente los recursos existentes o adquiriendo nuevos.</li>
